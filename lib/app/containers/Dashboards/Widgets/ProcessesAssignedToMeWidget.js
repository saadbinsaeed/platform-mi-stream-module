 ...
 */
class ProcessesAssignedToMeWidget extends _react.PureComponent {
  constructor(props) {
    super(props);
    props.loadProcessesAssigned(props.user, {
      linkOnly: true
    });
  }
...
_defineProperty(ProcessesAssignedToMeWidget, "propTypes", {
  loadProcessesAssigned: _propTypes.default.func,
