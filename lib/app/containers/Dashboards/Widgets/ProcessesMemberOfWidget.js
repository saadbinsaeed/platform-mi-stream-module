 ...
 */
class ProcessesMemberOfWidget extends _react.PureComponent {
  constructor(props) {
    super(props);
    props.loadProcessesMemberOf(props.user, {
      linkOnly: true
    });
  }
...
_defineProperty(ProcessesMemberOfWidget, "propTypes", {
  loadProcessesMemberOf: _propTypes.default.func,
...
var _default = (0, _reactRedux.connect)(mapStateToProps, {
  loadProcessesMemberOf: _dashboardActions.loadProcessesMemberOf
})(ProcessesMemberOfWidget);
