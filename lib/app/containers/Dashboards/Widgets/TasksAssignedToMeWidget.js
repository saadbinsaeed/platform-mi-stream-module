 ...
 */
class TasksAssignedToMeWidget extends _react.PureComponent {
  constructor(props) {
    super(props);
    props.loadTasksAssigned(props.user, {
      linkOnly: true
    });
  }
...
_defineProperty(TasksAssignedToMeWidget, "propTypes", {
  loadTasksAssigned: _propTypes.default.func,
...
var _default = (0, _reactRedux.connect)(mapStateToProps, {
  loadTasksAssigned: _dashboardActions.loadTasksAssigned
