 ...
 */
class TasksOwnedByMeWidget extends _react.PureComponent {
  constructor(props) {
    super(props);
    props.loadTasksOwned(props.user, {
      linkOnly: true
    });
  }
...
_defineProperty(TasksOwnedByMeWidget, "propTypes", {
  loadTasksOwned: _propTypes.default.func,
...
var _default = (0, _reactRedux.connect)(mapStateToProps, {
  loadTasksOwned: _dashboardActions.loadTasksOwned
})(TasksOwnedByMeWidget);
