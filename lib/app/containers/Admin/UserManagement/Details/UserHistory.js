 ...
 */
let UserHistory = (_class = (_temp = _class2 = class UserHistory extends _react.PureComponent {
  loadData(options) {
    const {
      user
    } = this.props;
  ...
  loadUserChangelog: _propTypes.default.func.isRequired,
...
var _default = (0, _reactRedux.connect)(state => ({
  ...
  changelog: (0, _lo.get)(state, 'admin.users.changelog.data.changes'),
  startIndex: (0, _lo.get)(state, 'admin.users.changelog.data.startIndex') || 0,
  count: (0, _lo.get)(state, 'admin.users.changelog.data.count')
}), {
  loadUserChangelog: _userManagementAction.loadUserChangelog
})(UserHistory);
