 ...
 */
class GroupsDropdownDeprecated extends _react.PureComponent {
  render() {
    return _react.default.createElement(_AutocompleteWrapper.default, _extends({
      valueProperty: "id"
    }, this.props, {
      Autocomplete: _GroupAutocomplete.default,
      graphqlQuery: _groupAutocompleteQuery.default
    }));
  }

}

_defineProperty(GroupsDropdownDeprecated, "propTypes", { ..._Autocomplete.default.propTypes,
  valueProperty: _propTypes.default.oneOf(['id', 'name'])
});

;
var _default = GroupsDropdownDeprecated;
