 ...
 */
class PeopleDropdownDeprecated extends _react.PureComponent {
  render() {
    return _react.default.createElement(_AutocompleteWrapper.default, _extends({
      valueProperty: "id"
    }, this.props, {
      Autocomplete: _PersonAutocomplete.default,
      graphqlQuery: _personAutocompleteQuery.default
    }));
  }

}

_defineProperty(PeopleDropdownDeprecated, "propTypes", { ..._Autocomplete.default.propTypes
});

;
var _default = PeopleDropdownDeprecated;
