 ...
 */
class UserDropdownDeprecated extends _react.PureComponent {
  render() {
    return _react.default.createElement(_AutocompleteWrapper.default, _extends({
      valueProperty: "login"
    }, this.props, {
      Autocomplete: _UserAutocomplete.default,
      graphqlQuery: _userAutocompleteQuery.default
    }));
  }

}

_defineProperty(UserDropdownDeprecated, "propTypes", { ..._Autocomplete.default.propTypes,
  valueProperty: _propTypes.default.oneOf(['id', 'login'])
});

;
var _default = UserDropdownDeprecated;
