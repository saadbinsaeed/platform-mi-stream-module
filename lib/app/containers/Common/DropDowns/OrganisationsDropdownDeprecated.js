 ...
 */
class OrganisationsDropdownDeprecated extends _react.PureComponent {
  render() {
    return _react.default.createElement(_AutocompleteWrapper.default, _extends({
      valueProperty: "id"
    }, this.props, {
      Autocomplete: _OrganisationAutocomplete.default,
      graphqlQuery: _organisationAutocompleteQuery.default
    }));
  }

}

_defineProperty(OrganisationsDropdownDeprecated, "propTypes", { ..._Autocomplete.default.propTypes
});

;
var _default = OrganisationsDropdownDeprecated;
