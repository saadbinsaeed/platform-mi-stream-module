 ...
 */
const move = (items, itemIndex, destinationIndex) => {
  const result = [...items];
...
const changeGroup = (sourceGroup, sourceIndex, destinationGroup, destinationIndex) => {
  ...
  sourceGroup.items.splice(sourceIndex, 1); // add the item in the destination group
