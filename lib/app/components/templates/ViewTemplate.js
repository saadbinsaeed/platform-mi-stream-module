 ...
 */
class ViewTemplate extends _react.PureComponent {
  constructor(...args) {
    super(...args);
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps.title !== title || prevProps.subTitle !== subTitle || prevProps.info && info && prevProps.info.length !== info.length || prevProps.menuItems !== menuItems || prevProps.color !== color) {
      this.setHeaderProps(this.props);
    }
  }
  /**
  ...
  render() {
    ...
    return _react.default.createElement(_ErrorBoundary.default, null, children);
  }

}

_defineProperty(ViewTemplate, "propTypes", {
