 ...
 */
class ClassificationAutocompleteWrapper extends _react.PureComponent {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "fetchEntity", (0, _debouncePromise.default)(id => {
      ...
      return _client.graphql.query({
        query: _classificationAutocompleteQuery.default,
        variables: {
          filterBy: [{
            field: 'id',
            op: '=',
...
var _default = ClassificationAutocompleteWrapper;
