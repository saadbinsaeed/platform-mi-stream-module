 ...
 */
let CustomEntityAdd = (_dec = (0, _decoratorUtils.memoize)(), (_class = (_temp = _class2 = class CustomEntityAdd extends _react.Component {
  constructor(...args) {
    super(...args);
    ...
    this.formRef.current.isValidForm().then(({
      ...
      if (!errors) {
        this.props.saveCustomEntity(data).then(result => {
          ...
          if (id) {
            _History.default.push(`/custom-entities/${id}/`);
          }
        });
      }
    });
