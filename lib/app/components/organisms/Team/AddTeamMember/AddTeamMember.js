 ...
 */
class AddTeamMember extends _react.PureComponent {
  /**
  ...
  render() {
    return _react.default.createElement("div", null, _react.default.createElement(_ActionBar.default, {
      ...
      name: "Select team members from the list"
      ...
      component: _react.default.createElement(_UserAvatar.default, {
        src: "https://lh3.googleusercontent.com/-HwObQVjQxpo/AAAAAAAAAAI/AAAAAAAAAAA/APJypA2-qVxWS0vplj3XvBhXvgLbYToe4A/s96-c-mo/photo.jpg",
        size: "lg",
        status: "busy",
        name: "Glen Scott"
      }),
