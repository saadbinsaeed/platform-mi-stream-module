 ...
 */
let AbstractEntityTypeahead = (_dec = (0, _decoratorUtils.debounce)(), (_class = (_temp = _class2 = class AbstractEntityTypeahead extends _react.PureComponent {
  optionTemplate(data) {
...
;
var _default = AbstractEntityTypeahead;
