 ...
 */
class GroupTypeahead extends _react.PureComponent {
  render() {
...
_defineProperty(GroupTypeahead, "propTypes", {
  loadGroupAutocomplete: _propTypes.default.func.isRequired,
  options: _propTypes.default.arrayOf(_propTypes.default.object),
  isLoading: _propTypes.default.bool,
  filterBy: _propTypes.default.oneOfType([_propTypes.default.func, _propTypes.default.arrayOf(_propTypes.default.object)])
});
...
var _default = (0, _reactRedux.connect)(state => ({
  ...
  loadGroupAutocomplete: _groupsActions.loadGroupAutocomplete
})(GroupTypeahead);
