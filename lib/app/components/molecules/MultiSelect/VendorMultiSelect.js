 ...
 */
class VendorMultiSelect extends _react.PureComponent {
  constructor(...args) {
    super(...args);
...
_defineProperty(VendorMultiSelect, "propTypes", { ..._MultiSelect.default.propTypes
});
...
var _default = (0, _reactRedux.connect)(state => ({
  ...
  loadOptions: _multiselectActions.loadVendors
})(VendorMultiSelect);
