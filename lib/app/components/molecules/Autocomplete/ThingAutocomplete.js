 ...
 */
class ThingAutocomplete extends _react.PureComponent {
  render() {
...
_defineProperty(ThingAutocomplete, "propTypes", { ..._Autocomplete.default.propTypes,
  loadThingAutocomplete: _propTypes.default.func.isRequired,
...
var _default = (0, _reactRedux.connect)(state => ({
  ...
  loadThingAutocomplete: _thingsActions.loadThingAutocomplete
})(ThingAutocomplete);
