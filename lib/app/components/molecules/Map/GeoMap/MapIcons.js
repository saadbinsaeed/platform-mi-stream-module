...
exports.TowerMarker = exports.CascadedMarker = exports.AccessMarker = exports.ForceMajeurMarker = exports.ActiveEquipmentMarker = exports.AcdgGenMarker = exports.DcdgGenMarker = exports.ControlPanelMarker = exports.InfrastructureMarker = exports.RectifierMarker = exports.DieselMarker = exports.SolarMarker = exports.HybridMarker = exports.ActivityMarker = exports.EnvironmentalMarker = exports.DefaultSvgMarker = exports.BaseSvgMarker = exports.Cluster1 = exports.Cluster1Component = exports.Cluster2 = exports.Cluster2Component = exports.Cluster3 = exports.Cluster4 = exports.MyMarker = exports.MyMarkerComponent = void 0;

var _react = _interopRequireDefault(require("react"));

var _styledComponents = _interopRequireDefault(require("styled-components"));

var _reactLeafletDivIcon = _interopRequireDefault(require("react-leaflet-div-icon"));

var _recompose = require("recompose");

var _PriorityColor = require("app/utils/styles/PriorityColor");
...
function convertPriorityStringToNumber(p) {
  return (0, _PriorityColor.priorityColor)(Number(Object.keys(p).toString().replace(/[^0-9.]/g, '')));
}
/**
...
const Svg = _styledComponents.default.svg.withConfig({
  displayName: "MapIcons__Svg",
  componentId: "sc-11tilb8-0"
})(["width:60px;background:transparent;border-radius:50%;"]);

const FeatureMarker = _styledComponents.default.div.withConfig({
  displayName: "MapIcons__FeatureMarker",
  componentId: "sc-11tilb8-1"
})(["position:absolute;z-index:1000;margin-left:-20px;margin-top:-20px;"]);

const ImageMarker = (0, _styledComponents.default)(FeatureMarker).withConfig({
  displayName: "MapIcons__ImageMarker",
  componentId: "sc-11tilb8-2"
})(["border-radius:50%;width:36px;height:36px;border:solid 2px white;"]);

const MyMarkerComponent = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position
  }, _react.default.createElement(ImageMarker, null, _react.default.createElement(_Avatar.default, {
...
exports.MyMarkerComponent = MyMarkerComponent;
const MyMarker = (0, _recompose.onlyUpdateForKeys)(['position', 'user'])(MyMarkerComponent);
exports.MyMarker = MyMarker;

const Cluster4Component = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position,
    onClick: props.onClick
  }, _react.default.createElement(FeatureMarker, null, _react.default.createElement(Svg, {
    width: "100%",
    height: "100%",
    viewBox: "0 0 126 129"
  }, _react.default.createElement("g", {
    transform: "matrix(0.065625,0,0,0.119444,0,0)"
    ...
    transform: "matrix(15.2381,0,0,8.37209,-594.286,-552.558)"
    ...
    transform: "matrix(15.2381,0,0,8.37209,-579.048,-510.698)"
  }, _react.default.createElement("g", {
    transform: "matrix(1,0,0,1,2.08337e-05,-12)"
  }, _react.default.createElement("path", {
    d: "M100.5,83L100.5,83C130.027,83 154,106.973 154,136.5L100.5,136.5L100.5,83Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[1])
  })), _react.default.createElement("g", {
    transform: "matrix(-1,0,0,1,201,-12)"
  }, _react.default.createElement("path", {
    d: "M100.5,83L100.5,83C130.027,83 154,106.973 154,136.5L100.5,136.5L100.5,83Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[3])
  })), _react.default.createElement("g", {
    transform: "matrix(1,0,0,-1,1.04168e-05,261)"
  }, _react.default.createElement("path", {
    d: "M100.5,83L100.5,83C130.027,83 154,106.973 154,136.5L100.5,136.5L100.5,83Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[0])
  })), _react.default.createElement("g", {
    transform: "matrix(-1,0,0,-1,201,261)"
  }, _react.default.createElement("path", {
    d: "M100.5,83L100.5,83C130.027,83 154,106.973 154,136.5L100.5,136.5L100.5,83Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[2])
  }))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,-73.8652,20.5931)"
  ...
  }, convertPriorityLevel(props.priorityLevels[3]))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,623.133,23.1673)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[2]))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,-65.9081,406.714)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[1]))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,585.336,409.288)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[0])))))));
};

const Cluster4 = (0, _recompose.onlyUpdateForKeys)(['position', 'priorityLevels', 'onClick'])(Cluster4Component);
exports.Cluster4 = Cluster4;

const Cluster3Component = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position,
    onClick: props.onClick
  }, _react.default.createElement(FeatureMarker, null, _react.default.createElement(Svg, {
    ...
    transform: "matrix(0.065625,0,0,0.119444,314,0)"
  }, _react.default.createElement("rect", {
    x: "0",
    y: "0",
    width: "1920",
    ...
    transform: "matrix(15.2381,0,0,8.37209,-594.286,-544.186)"
  }, _react.default.createElement("circle", {
    cx: "101.5",
    cy: "129.5",
    r: "61.5",
    ...
    transform: "matrix(15.2381,0,0,8.37209,-579.047,-2819.31)"
  }, _react.default.createElement("g", {
    transform: "matrix(1,0,0,1,-1.39247e-05,33)"
  }, _react.default.createElement("path", {
    d: "M100.5,315L100.5,368.5L54.168,395.25C49.628,387.387 47.166,378.502 47.008,369.433L47.006,369.284L47.004,369.163L47.001,368.885L47.001,368.802L47,368.5C47,338.972 70.972,315 100.5,315Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[2])
  })), _react.default.createElement("g", {
    transform: "matrix(-1,0,0,1,201,33)"
  }, _react.default.createElement("path", {
    d: "M100.5,315L100.5,368.5L54.168,395.25C49.628,387.387 47.166,378.502 47.008,369.433L47.006,369.284L47.004,369.163L47.001,368.885L47.001,368.802L47,368.5C47,338.972 70.972,315 100.5,315Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[1])
  })), _react.default.createElement("g", {
    transform: "matrix(0.5,-0.866025,-0.866025,-0.5,369.213,672.286)"
  }, _react.default.createElement("path", {
    d: "M100.5,315L100.5,368.5L54.168,395.25C49.628,387.387 47.166,378.502 47.008,369.433L47.006,369.284L47.004,369.163L47.001,368.885L47.001,368.802L47,368.5C47,338.972 70.972,315 100.5,315Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[0])
  }))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,-143.774,110.688)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[0]))), _react.default.createElement("g", {
    transform: "matrix(15.2381,0,0,8.37209,611.716,107.47)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
    ...
    transform: "matrix(15.2381,0,0,8.37209,248.612,471.068)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[2]))))))));
};

const Cluster3 = (0, _recompose.onlyUpdateForKeys)(['position', 'priorityLevels', 'onClick'])(Cluster3Component);
exports.Cluster3 = Cluster3;

const Cluster2Component = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position,
    onClick: props.onClick
  }, _react.default.createElement(FeatureMarker, null, _react.default.createElement(Svg, {
    ...
    transform: "matrix(15.2381,0,0,8.37209,-579.048,-544.186)"
  }, _react.default.createElement("circle", {
    cx: "101.5",
    cy: "129.5",
    r: "61.5",
    ...
    transform: "matrix(15.2381,0,0,8.37209,-563.81,-1573.95)"
  }, _react.default.createElement("path", {
    d: "M100.5,252.5L100.5,306L100.5,306L100.493,306C70.969,305.996 47,282.025 47,252.5C47,222.973 70.972,199 100.5,199L100.5,252.5Z",
    fill: convertPriorityStringToNumber(props.priorityLevels[1])
  }), _react.default.createElement("g", {
    ...
    transform: "matrix(15.2381,0,0,8.37209,-134.448,223.307)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
    ...
    transform: "matrix(15.2381,0,0,8.37209,650.324,220.089)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
  ...
  }, convertPriorityLevel(props.priorityLevels[1]))))))));
};

exports.Cluster2Component = Cluster2Component;
const Cluster2 = (0, _recompose.onlyUpdateForKeys)(['position', 'priorityLevels', 'onClick'])(Cluster2Component);
exports.Cluster2 = Cluster2;

const Cluster1Component = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position,
    onClick: props.onClick
  }, _react.default.createElement(FeatureMarker, null, _react.default.createElement(Svg, {
    ...
    id: "mapchart1x",
    transform: "matrix(0.065625,0,0,0.119444,628.775,0)"
  }, _react.default.createElement("rect", {
    x: "0",
    y: "0",
    width: "1920",
    ...
    transform: "matrix(15.2381,0,0,8.37209,-7135.05,-5.14828)"
  }, _react.default.createElement("circle", {
    cx: "532.312",
    cy: "65.435",
    r: "53.192",
    ...
    transform: "matrix(15.2381,0,0,8.37209,278.544,229.109)"
  }, _react.default.createElement("text", {
    x: "39.428px",
    y: "44.72px",
    style: {
...
exports.Cluster1Component = Cluster1Component;
const Cluster1 = (0, _recompose.onlyUpdateForKeys)(['position', 'priorityLevels', 'onClick'])(Cluster1Component);
exports.Cluster1 = Cluster1;
const baseSvgMarketSize = {
  width: '70px',
  height: '70px'
};

const BaseSvgMarkerComponent = props => {
  return _react.default.createElement(_reactLeafletDivIcon.default, {
    position: props.position,
    onClick: props.onClick
  }, _react.default.createElement(FeatureMarker, {
    style: baseSvgMarketSize
    ...
    d: "M35.436,5.615c-11.244,0 -20.359,8.977 -20.359,20.051c0,3.562 0.971,6.893 2.624,9.79c0.275,0.481 0.563,0.955 0.875,1.411l16.86,28.901l16.86,-28.901c0.259,-0.378 0.483,-0.779 0.715,-1.175l0.16,-0.236c1.652,-2.897 2.624,-6.228 2.624,-9.79c0,-11.074 -9.116,-20.051 -20.359,-20.051Z",
    fill: (0, _PriorityColor.priorityColor)(Number(props.priority))
  }), _react.default.createElement("svg", {
    x: "23",
    y: "18",
    width: "100%",
    height: "100%",
    viewBox: "0 0 69 69"
  }, props.svgIconPath && _react.default.createElement("path", {
    fill: "white",
    d: props.svgIconPath
  }) || _react.default.createElement("circle", {
    cx: "12.156",
...
exports.AcdgGenMarker = AcdgGenMarker;
const ActiveEquipmentMarker = (0, _recompose.onlyUpdateForKeys)(iconKeys)(props => {
  return _react.default.createElement(BaseSvgMarker, {
    svgIconPath: 'M12,6A6,6 0 0,1 18,12C18,14.22 16.79,16.16 15,17.2V19A1,1 0 0,1 14,20H10A1,1 0 0,1 9,19V17.2C7.21,16.16 6,14.22 6,12A6,6 0 0,1 12,6M14,21V22A1,1 0 0,1 13,23H11A1,1 0 0,1 10,22V21H14M20,11H23V13H20V11M1,11H4V13H1V11M13,1V4H11V1H13M4.92,3.5L7.05,5.64L5.63,7.05L3.5,4.93L4.92,3.5M16.95,5.63L19.07,3.5L20.5,4.93L18.37,7.05L16.95,5.63Z',
    position: props.position,
    priority: props.priority,
    onClick: props.onClick
  });
});
exports.ActiveEquipmentMarker = ActiveEquipmentMarker;
const ForceMajeurMarker = (0, _recompose.onlyUpdateForKeys)(iconKeys)(props => {
  return _react.default.createElement(BaseSvgMarker, {
    svgIconPath: 'M14.04,12H10V11H5.5A3.5,3.5 0 0,1 2,7.5A3.5,3.5 0 0,1 5.5,4C6.53,4 7.45,4.44 8.09,5.15C8.5,3.35 10.08,2 12,2C13.92,2 15.5,3.35 15.91,5.15C16.55,4.44 17.47,4 18.5,4A3.5,3.5 0 0,1 22,7.5A3.5,3.5 0 0,1 18.5,11H14.04V12M10,16.9V15.76H5V13.76H19V15.76H14.04V16.92L20,19.08C20.58,19.29 21,19.84 21,20.5A1.5,1.5 0 0,1 19.5,22H4.5A1.5,1.5 0 0,1 3,20.5C3,19.84 3.42,19.29 4,19.08L10,16.9Z',
    position: props.position,
    priority: props.priority,
    onClick: props.onClick
  });
});
exports.ForceMajeurMarker = ForceMajeurMarker;
const AccessMarker = (0, _recompose.onlyUpdateForKeys)(iconKeys)(props => {
  return _react.default.createElement(BaseSvgMarker, {
    svgIconPath: 'M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z',
    position: props.position,
    priority: props.priority,
    onClick: props.onClick
  });
});
exports.AccessMarker = AccessMarker;
const CascadedMarker = (0, _recompose.onlyUpdateForKeys)(iconKeys)(props => {
  return _react.default.createElement(BaseSvgMarker, {
    svgIconPath: 'M12,10A2,2 0 0,1 14,12C14,12.5 13.82,12.94 13.53,13.29L16.7,22H14.57L12,14.93L9.43,22H7.3L10.47,13.29C10.18,12.94 10,12.5 10,12A2,2 0 0,1 12,10M12,8A4,4 0 0,0 8,12C8,12.5 8.1,13 8.28,13.46L7.4,15.86C6.53,14.81 6,13.47 6,12A6,6 0 0,1 12,6A6,6 0 0,1 18,12C18,13.47 17.47,14.81 16.6,15.86L15.72,13.46C15.9,13 16,12.5 16,12A4,4 0 0,0 12,8M12,4A8,8 0 0,0 4,12C4,14.36 5,16.5 6.64,17.94L5.92,19.94C3.54,18.11 2,15.23 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12C22,15.23 20.46,18.11 18.08,19.94L17.36,17.94C19,16.5 20,14.36 20,12A8,8 0 0,0 12,4Z',
    position: props.position,
    priority: props.priority,
    onClick: props.onClick
  });
});
exports.CascadedMarker = CascadedMarker;
const TowerMarker = (0, _recompose.onlyUpdateForKeys)(iconKeys)(props => {
  return _react.default.createElement(BaseSvgMarker, {
    svgIconPath: 'M12,10A2,2 0 0,1 14,12C14,12.5 13.82,12.94 13.53,13.29L16.7,22H14.57L12,14.93L9.43,22H7.3L10.47,13.29C10.18,12.94 10,12.5 10,12A2,2 0 0,1 12,10M12,8A4,4 0 0,0 8,12C8,12.5 8.1,13 8.28,13.46L7.4,15.86C6.53,14.81 6,13.47 6,12A6,6 0 0,1 12,6A6,6 0 0,1 18,12C18,13.47 17.47,14.81 16.6,15.86L15.72,13.46C15.9,13 16,12.5 16,12A4,4 0 0,0 12,8M12,4A8,8 0 0,0 4,12C4,14.36 5,16.5 6.64,17.94L5.92,19.94C3.54,18.11 2,15.23 2,12A10,10 0 0,1 12,2A10,10 0 0,1 22,12C22,15.23 20.46,18.11 18.08,19.94L17.36,17.94C19,16.5 20,14.36 20,12A8,8 0 0,0 12,4Z',
    position: props.position,
    priority: props.priority,
...
exports.TowerMarker = TowerMarker;